...
R: O número máximo de páginas depende do seu plano. O crawler segue links a partir da sua URL inicial até o limite de profundidade configurado.
...
R: Páginas podem falhar devido a proteção contra bots (firewalls como Cloudflare), erros do servidor ou conteúdo vazio. O crawl mostrará status "Partial Success".
