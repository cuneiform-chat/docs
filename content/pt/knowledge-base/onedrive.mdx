...
Importe documentos do OneDrive para treinar seus agents de AI.

## Visão Geral

Conecte sua conta Microsoft ao Cuneiform Chat e importe documentos diretamente para seu conteúdo. Seu agent de AI pode então responder perguntas com base no conteúdo desses documentos.
...
### Passo 2: Conecte o OneDrive

1. Clique no **ícone do OneDrive** na linha de ícones de cloud storage
2. Faça login com sua conta Microsoft (se solicitado)
3. Conceda permissão ao Cuneiform Chat para acessar seus arquivos

### Passo 3: Selecione Arquivos

1. Use o seletor de arquivos do OneDrive para navegar pelos seus arquivos
...
- **Sem acesso de escrita** à sua conta OneDrive
- **Sem acesso** a arquivos que você não escolher explicitamente

import { Callout } from 'nextra/components'

<Callout type="info">
  Você pode revogar o acesso a qualquer momento em sua Conta Microsoft → Privacidade → Aplicativos e serviços.
</Callout>
...
2. **Seleção** — Escolha arquivos específicos pelo seletor do OneDrive
...
- **Organize primeiro** — Estruture suas pastas no OneDrive antes de importar
...
### Não Consigo Conectar ao OneDrive

- Verifique se está logado na conta Microsoft correta
- Confirme que aplicativos de terceiros são permitidos nas suas configurações da Microsoft
...
- Suas credenciais da Microsoft são criptografadas
