...
O editor é o **mesmo** da Loja no Telegram — veja [Loja no Telegram: O editor](/integrations/telegram-mini-app#o-editor) para o tour completo (layout de 3 painéis, ciclo de vida draft/publish, cropper de imagem, limites por plano). A única superfície específica do canal é a aba **Distribute**.
...
Veja [Loja no Telegram: Consultas de pedido e carrinho](/integrations/telegram-mini-app#consultas-de-pedido-e-carrinho-opcional) para o passo a passo completo do fluxo de pedido (campos do formulário, limites anti-spam, janela de deduplicação) — tudo compartilhado com o Messenger.
