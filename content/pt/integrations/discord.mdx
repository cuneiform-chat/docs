...
- [Anexos de documentos](/integrations/document-attachments) — anexe um arquivo e pergunte sobre ele (desativado por padrão, planos pagos)
...
No Discord isso vem **desativado por padrão**: um admin ativa **Permitir anexos de documentos** no card da integração. Veja [Anexos de Documentos](/integrations/document-attachments) para os tipos suportados, os limites e a configuração.
