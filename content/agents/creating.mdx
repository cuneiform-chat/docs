...
Choose which language your agent responds in. Select a specific language or leave it as **Inherit from organization** to use the organization's default (set in Account Management).

24 languages are supported. See [Agent Personas — Response Language](/agents/agent-personas#4-response-language) for details.
