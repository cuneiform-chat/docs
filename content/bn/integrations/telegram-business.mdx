...
Telegram Premium co-pilot provides:
...
The regular [Telegram integration](/integrations/telegram) connects an agent to **a bot's own inbox** — your end users DM the bot directly at `t.me/<bot>`. Telegram Premium co-pilot is the opposite: the bot replies on a **person's personal Telegram account**, intercepting DMs that come into that person's normal chat list.
...
2. Find the **Telegram Premium co-pilot** card
3. Click **Connect Premium bot**
...
1. On the Telegram Premium card, click **Link a Premium user** — a 10-minute code appears (with a QR shortcut)
...
1. Open the Telegram Premium card in Cuneiform Chat
...
To remove a Telegram Premium integration:

1. **From Cuneiform Chat:** Integrations → Telegram Premium co-pilot card → three-dot menu → **Delete**
