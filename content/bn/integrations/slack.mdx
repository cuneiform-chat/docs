...
- [নথি সংযুক্তি](/integrations/document-attachments) — একটি file আপলোড করে সে সম্পর্কে জিজ্ঞাসা করুন (ডিফল্টে চালু, paid plan)
...
কেউ একটি DM বা channel-এ file আপলোড করে আপনার agent-কে সে সম্পর্কে জিজ্ঞাসা করতে পারেন। শুধু **Slack-এ আপলোড করা** file পড়া হয় — Google Drive, Dropbox বা অন্য কোনো পরিষেবা থেকে কেবল link করা file আনা হয় না। এক message-এ একাধিক file থাকলে সবগুলোই পড়া হয়।

Slack-এ এটি **ডিফল্টে চালু**: একজন admin চাইলে integration card-এ **নথি সংযুক্তির অনুমতি দিন** বন্ধ করতে পারেন। সমর্থিত type, সীমা ও setup-এর জন্য [নথি সংযুক্তি](/integrations/document-attachments) দেখুন।
