...
- [নথি সংযুক্তি](/integrations/document-attachments) — একটি file আপলোড করে সে সম্পর্কে জিজ্ঞাসা করুন (ডিফল্টে বন্ধ, paid plan)
...
Slack-এ এটি **ডিফল্টে বন্ধ**: একজন admin integration card-এ **নথি সংযুক্তির অনুমতি দিন** চালু করেন। সমর্থিত type, সীমা ও setup-এর জন্য [নথি সংযুক্তি](/integrations/document-attachments) দেখুন।
