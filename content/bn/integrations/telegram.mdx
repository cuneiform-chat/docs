...
- [নথি সংযুক্তি](/integrations/document-attachments) — একটি file পাঠিয়ে সে সম্পর্কে জিজ্ঞাসা করুন (ডিফল্টে চালু, paid plan)
...
Telegram-এ এটি **ডিফল্টে চালু**: একজন admin চাইলে integration card-এ **নথি সংযুক্তির অনুমতি দিন** বন্ধ করতে পারেন। ছবি বা scan-এর জন্য এখনও **জটিল নথির জন্য প্রিমিয়াম পার্সিং** লাগে, যা একজন admin চালু না করা পর্যন্ত বন্ধ থাকে। সমর্থিত type, সীমা ও setup-এর জন্য [নথি সংযুক্তি](/integrations/document-attachments) দেখুন।
