...
- [নথি সংযুক্তি](/integrations/document-attachments) — একটি file attach করে সে সম্পর্কে জিজ্ঞাসা করুন (ডিফল্টে চালু, paid plan)
...
Discord-এ এটি **ডিফল্টে চালু**: একজন admin চাইলে integration card-এ **নথি সংযুক্তির অনুমতি দিন** বন্ধ করতে পারেন। সমর্থিত type, সীমা ও setup-এর জন্য [নথি সংযুক্তি](/integrations/document-attachments) দেখুন।
