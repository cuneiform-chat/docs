...
- **Customer-রা কখনো Messenger ছাড়ে না।** কোনো app install নেই, মনে রাখার মতো কোনো domain নেই, নিজে বানানোর মতো কোনো আলাদা checkout পাতা নেই। storefront Messenger-এর WebView-তে খোলে এবং user-এর theme ও ভাষা উত্তরাধিকার সূত্রে পায়।
...
- **প্রতিটি plan-এ free।** page, প্রতি page-এ block বা product doc-এ কোনো cap নেই — কোনো plan-এই নয়, free trial সহ। Pricing per-org — একটি দ্বিতীয় Facebook Page যোগ করলে আপনার price পরিবর্তন হয় না।
...
- **Product পাওয়ার দুটি উপায়।** **হাতে সাজানো** একটি storefront একটি পরিপাটি catalog + lead-capture surface: product আপনি নিজে লেখেন, আর সেটি কোনো payment, inventory বা shipping করে না। **Catalog-এর সাথে জোড়া** একটি storefront আপনার [যুক্ত Shopify বা WooCommerce store](/commerce) থেকে product নেয় এবং ক্রেতাদের আপনার আসল checkout-এ পাঠায়।
...
Telegram Storefront-এর মতোই একই scope। এই সীমাবদ্ধতাগুলো সেই storefront-এর জন্য যাতে product আপনি নিজে লিখেছেন — [catalog-এর সাথে জোড়া storefront](/integrations/telegram-mini-app#catalog-linked-storefronts) প্রথম তিনটি তুলে দেয়, কারণ সে product, stock ও checkout আপনার যুক্ত store থেকেই নেয়।

- **নিজস্ব কোনো payment নেই।** Order CTA inquiry handoff, Checkout API বা Stripe নয়। (Catalog-জোড়া storefront বদলে আপনার store-এর checkout-এ handoff করে — দেখুন [Checkout](/commerce/checkout)।)
- **কোনো inventory tracking নেই।** Product card-এ availability badge হলো free-text label যা আপনি manually edit করেন ("Sold out", "Pre-order", "Last 3")। (Catalog-জোড়া storefront আপনার store থেকে আসল stock পড়ে।)
