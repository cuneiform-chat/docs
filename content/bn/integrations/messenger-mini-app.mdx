...
<Callout type="info">
  এই page-টি customer-facing storefront Mini App cover করে যা প্রতিটি **Meta (Facebook)** integration-এর সাথে আসে। storefront engine-টি [Telegram Storefront](/integrations/telegram-mini-app)-এর সাথে shared — একই composer, একই block, একই theme। শুধু launcher ও কয়েকটি Messenger-নির্দিষ্ট আচরণ আলাদা।
</Callout>
