...
<Callout type="info">
  This page covers the customer-facing storefront Mini App that ships with every **Meta (Facebook)** integration. The storefront engine is shared with the [Telegram Storefront](/integrations/telegram-mini-app) — same composer, same blocks, same themes. Only the launcher and a few Messenger-specific behaviors differ.
</Callout>
