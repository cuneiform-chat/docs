...
আপনার AI agent-দের train করতে OneDrive থেকে document import করুন।

## সংক্ষিপ্ত বিবরণ

আপনার Microsoft account Cuneiform Chat-এ সংযুক্ত করুন এবং সরাসরি আপনার content-এ document import করুন। এরপর আপনার AI agent এই document-এর content-এর উপর ভিত্তি করে প্রশ্নের উত্তর দিতে পারবে।
...
### Step 2: OneDrive সংযুক্ত করুন

1. Cloud storage icon row-তে **OneDrive icon**-এ click করুন
2. আপনার Microsoft account দিয়ে sign in করুন (জিজ্ঞাসা করলে)
3. আপনার file access করার জন্য Cuneiform Chat-কে permission দিন

### Step 3: File নির্বাচন করুন

1. আপনার file browse করতে OneDrive file picker ব্যবহার করুন
...
| Web/Data | .html, .htm, .json, .xml | Web page ও structured data |
...
- আপনার OneDrive account-এ **কোনো write access নেই**
- আপনি স্পষ্টভাবে নির্বাচন করেননি এমন file-এ **কোনো access নেই**

import { Callout } from 'nextra/components'

<Callout type="info">
  আপনি যেকোনো সময় Microsoft Account → Privacy → Apps and services থেকে access প্রত্যাহার করতে পারেন।
</Callout>
...
```mermaid
graph LR
    A[OneDrive-এ File নির্বাচন] --> B[Cuneiform-এ Download]
    B --> C[Text Extract]
    C --> D[Embedding তৈরি]
...
2. **Selection** — OneDrive-এর picker-এর মাধ্যমে নির্দিষ্ট file বেছে নিন
...
- **আগে সংগঠিত করুন** — Import-এর আগে আপনার OneDrive folder সাজান
...
### OneDrive-এ সংযোগ করতে পারছেন না

- সঠিক Microsoft account-এ sign in আছেন কিনা যাচাই করুন
- আপনার Microsoft setting-এ third-party app অনুমোদিত কিনা পরীক্ষা করুন
...
- আপনার Microsoft credential encrypted
