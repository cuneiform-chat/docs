...
Sidebar-এ **Knowledge**-এ navigate করুন, তারপর **Website** tab-এ click করুন।
...
| Crawling | সক্রিয়ভাবে page visit হচ্ছে |
| Completed | সব reachable page crawl সম্পন্ন |
| Partial | কিছু page crawl হয়েছে, কিছু ব্যর্থ |
...
উত্তর: সর্বোচ্চ page সংখ্যা আপনার plan-এর উপর নির্ভর করে। Crawler আপনার starting URL থেকে ২ level গভীরতা পর্যন্ত link follow করে।
...
উত্তর: Bot protection (Cloudflare-এর মতো firewall), server error, বা খালি content-এর কারণে page ব্যর্থ হতে পারে। Crawl "Partial" status দেখাবে।
...
উত্তর: Knowledge page-এর **Documents** tab-এ। সেগুলো Markdown (.md) file হিসেবে দেখা যায়।
