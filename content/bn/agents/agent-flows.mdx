...
<Callout type="info">
  Agent Forms **WhatsApp, Telegram, Messenger এবং আপনার ওয়েবসাইটের chat widget**-এ চলে, এবং এটি সবার জন্যই উন্মুক্ত — ফ্রি ট্রায়াল সহ। একবার একটি flow তৈরি করুন; এটি প্রতিটি সমর্থিত channel-এ native ভাবে render হয়।
</Callout>
...
Flow-গুলো customer admin panel-এ **Agent Forms**-এর অধীনে থাকে। প্রতিটি flow-এ রয়েছে:
...
আপনাকে একটি খালি composer থেকে শুরু করতে হবে না। ready-made flow-এর একটি curated library দেখতে Agent Forms তালিকায় **Templates** tab খুলুন — lead capture, demo booking, support intake, product feedback এবং আরও অনেক কিছু। **Use this template**-এ click করুন এবং এটি আপনার নিজের workspace-এ একটি editable draft তৈরি করে: screen, field, logic ও translation আগে থেকেই পূরণ করা থাকে। Draft-টিকে একটি WhatsApp number-এর সাথে bind করুন, যা ইচ্ছা পরিবর্তন করুন এবং publish করুন।
...
Agent Forms নিজে সবার জন্যই উন্মুক্ত, ফ্রি ট্রায়াল সহ — প্রথম flow বানানোর আগে unlock করার মতো কিছু নেই। আপনার সাবস্ক্রিপশন যেটি নিয়ন্ত্রণ করে তা আলাদা: একসাথে কতগুলো flow **published** থাকতে পারে, আর published প্রতিটি flow কতগুলো ভাষায় প্রকাশ পায়।
