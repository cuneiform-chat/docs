...
Multi-screen WhatsApp form যা একটি AI agent কথোপকথনের মাঝপথে আপনার customer-কে দিতে পারে। Agent কখন structured তথ্য চাইবে তা নিজেই সিদ্ধান্ত নেয় — নাম, তারিখ, upload করা ID-র ছবি, একটি multi-step questionnaire — এবং আপনার customer দীর্ঘ পাল্টাপাল্টি chat-এর বদলে একটি native WhatsApp form-এ তা পূরণ করে।

import { Callout } from 'nextra/components'

<Callout type="info">
  Agent Flows **WhatsApp**-এ চলে এবং **সব paid plan**-এ available (tier-limited — নিচের Tier limits টেবিল দেখুন)। Web widget, Telegram ও Messenger renderer roadmap-এ রয়েছে।
</Callout>
