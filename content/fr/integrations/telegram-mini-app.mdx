...
- **Vos clients ne quittent jamais Telegram.** Pas d'installation d'app, pas de domaine à retenir et pas de page de checkout séparée à construire. La boutique s'ouvre dans la WebView de Telegram et hérite du thème, de la langue et de la connexion de l'utilisateur.
- **Une seule pression depuis une conversation.** Le bouton menu à côté du compositeur est mis en place dès que vous connectez le bot ; une fois que vous avez créé une boutique et que vous la publiez sur le bot, le bouton l'ouvre. Le libellé bascule automatiquement sur **« Shop »** dès que vous publiez un produit — aucune configuration BotFather requise.
- **Une boutique, les deux canaux.** Créez la boutique une seule fois et publiez-la sur un bot Telegram *et* une Page Facebook Messenger en même temps — les mêmes pages, produits et thème sur les deux. Publiez chaque canal depuis l'onglet **Distribute** ; dépubliez l'un sans toucher à l'autre.
...
- **Gratuit sur tous les plans.** Aucun plafond sur les pages, les blocs par page ou les docs produit — sur aucun plan, essai gratuit compris. La tarification est par organisation — ajouter un deuxième bot Telegram ne change pas votre prix.
...
- **Boutique multilingue** — rédigez le contenu de votre boutique dans n'importe quelle langue prise en charge par WhatsApp (avec une traduction par IA en un clic pour combler les manques), et un sélecteur de langue intégré laisse chaque visiteur choisir la sienne. Les langues de droite à gauche (arabe, hébreu, persan, ourdou) s'affichent correctement. Le chrome de la coquille suit, lui, la langue de l'appareil du visiteur.
...
- **Deux façons d'alimenter les produits.** Une boutique **construite à la main** est une surface catalogue + capture de leads soignée — vous saisissez les produits vous-même, et elle ne fait ni paiements, ni suivi des stocks, ni livraison ; associez-la à un humain dans votre inbox et vous avez une boucle de vente complète. Une boutique **reliée au catalogue** tire ses produits d'une boutique Shopify ou WooCommerce connectée et transfère les acheteurs vers votre vrai checkout. [Voir ci-dessous](#catalog-linked-storefronts).
...
<Callout type="info">
  **Deux façons de démarrer une boutique.** La plus rapide est le hub **Storefront** (menu latéral → **Storefront** → **Créer une boutique**) : il crée une boutique vierge que vous pouvez d'abord construire, puis publier sur n'importe quel canal — un bot Telegram, une Page Facebook ou les deux — depuis son onglet **Distribute**. L'entrée par bot ci-dessous (**Intégrations → votre bot → Configurer la mini app**) fonctionne toujours et reste pratique quand vous êtes déjà sur la carte du bot.
</Callout>
...
|---------|-------------------|
| **Rail gauche** | Votre liste de pages (glissez pour réordonner). L'entrée **Help Center** épinglée est en lecture seule ici — vous éditez ces entrées depuis un panneau séparé. Sous la liste des pages : contrôles par intégration (on/off boutique, libellé du bouton menu) et le sélecteur de langue pour rédiger les traductions. |
...
Rédigez votre boutique une fois en anglais, puis ajoutez des traductions pour n'importe quelle langue prise en charge par WhatsApp. Ouvrez le sélecteur de langue dans le compositeur, choisissez une langue cible et saisissez vous-même les traductions ou cliquez sur **Traduire** pour obtenir un brouillon par IA en un clic que vous pourrez modifier. Les variantes régionales sont de premier ordre — portugais brésilien vs européen, chinois simplifié vs traditionnel, etc. — pour parler à chaque marché dans sa propre forme.

Lorsqu'une boutique a plus d'une langue, un **sélecteur de langue** apparaît pour les visiteurs, et la boutique détecte automatiquement la langue de l'appareil de chaque visiteur (avec l'anglais en repli). Les langues de droite à gauche comme l'arabe s'affichent correctement. Cela traduit le **contenu** que vous avez rédigé (titres de hero, noms de produit, FAQ, rich-text) — le chrome de la coquille (tiroir, boutons système) suit séparément la langue de l'appareil du visiteur.
...
Aucun plafond ne s'applique au nombre total de docs produit que vous pouvez attacher (voir [Limites de palier](#tier-limits)).

## Demandes de commande & panier (optionnel) [#orders-and-cart]

Vous pouvez attacher un **Order CTA** à n'importe quelle product card ou product grid. Sur une boutique **construite à la main**, c'est purement un transfert de message structuré — **pas de paiements, pas de stocks, pas de fulfillment** — et il arrive dans votre inbox pour qu'un humain le reprenne. Sur une boutique **reliée au catalogue**, le même CTA peut transférer l'acheteur vers le vrai checkout de votre boutique ; voir [Boutiques reliées au catalogue](#catalog-linked-storefronts).
...
## Boutiques reliées au catalogue [#catalog-linked-storefronts]

Tout ce qui précède décrit une boutique que vous construisez à la main : vous saisissez les produits, les prix et la disponibilité, et les commandes arrivent sous forme de demandes. C'est toujours la bonne forme pour une plaquette, un catalogue de services ou une carte.

Si vous avez une **[boutique Shopify ou WooCommerce connectée](/commerce)**, une boutique peut à la place être **reliée à ce catalogue**. Ses blocs produit sont tirés de votre vrai catalogue, les prix et le stock viennent de la boutique plutôt que d'un champ que vous tenez à la main, et ses Order CTA peuvent transférer un acheteur prêt à acheter vers le checkout de votre propre boutique avec son panier intact — voir [Checkout](/commerce/checkout).

| | Construite à la main | Reliée au catalogue |
|---|---|---|
| **Produits** | Vous les saisissez | Tirés de votre boutique connectée |
| **Prix et disponibilité** | Des champs texte libre que vous entretenez | Lus depuis votre boutique |
| **Order CTA** | Transfert de demande vers votre Inbox | Transfert vers le checkout de votre boutique |
| **Nécessite une boutique connectée** | Non | Oui |

Une boutique est rattachée à une seule source et, dès qu'elle porte des blocs produit, ce rattachement est figé — une boutique construite à la main ne peut donc pas se mettre à se comporter en silence comme une boutique reliée au catalogue, ni l'inverse. Les boutiques créées avant l'existence de la liaison au catalogue ne sont rattachées à rien et continuent de fonctionner exactement comme avant.
...
## Limites de palier [#tier-limits]

Disponible sur tous les plans, y compris l'essai gratuit — et il n'y a **aucun plafond** sur les pages, les blocs par page ou les docs produit, sur aucun plan, essai gratuit compris.

Remarques :

- Une product grid ou un carousel **compte comme 1 bloc** dans la liste de blocs du compositeur, quel que soit le nombre d'éléments ou de diapos qu'il contient.
- **La tarification est par organisation, pas par bot.** Ajouter un deuxième (ou cinquième) bot Telegram à votre organisation **ne change pas** votre prix. Chaque bot a sa propre boutique au sein du même plan.
...
## Ce qu'une boutique construite à la main NE fait PAS

Ces limites s'appliquent à une boutique dont vous avez saisi les produits vous-même. Une [boutique reliée au catalogue](#catalog-linked-storefronts) lève les trois premières en tirant ses produits — et son checkout — de votre boutique connectée.

- **Pas de paiements en propre.** Les Order CTA sont des transferts de demande, pas des checkouts Stripe / WhatsApp Pay / Telegram Stars. (Une boutique reliée au catalogue transfère vers le checkout de votre boutique au lieu d'encaisser ici.)
- **Pas de suivi des stocks.** Les badges de disponibilité sont des libellés texte libre que vous éditez manuellement. (Une boutique reliée au catalogue lit le vrai stock de votre boutique.)
- **Pas de calculs de livraison / validation d'adresse.** L'adresse de livraison est collectée en tant que texte libre. (La livraison sur une boutique reliée au catalogue est celle de votre propre boutique, calculée à son checkout.)
