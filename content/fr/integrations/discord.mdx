...
- [Pièces jointes](/integrations/document-attachments) — joignez un fichier et posez des questions à son sujet (activé par défaut, plans payants)
...
Sur Discord, c'est **activé par défaut** : un administrateur peut désactiver **Autoriser les pièces jointes** sur la carte d'intégration. Voir [Pièces Jointes de Documents](/integrations/document-attachments) pour les types pris en charge, les limites et la configuration.
