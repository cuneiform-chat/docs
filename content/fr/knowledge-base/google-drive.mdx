...
Importez des documents depuis Google Drive pour entraîner vos agents IA.

## Aperçu

Connectez votre compte Google à Cuneiform Chat et importez des documents directement dans votre contenu. Votre agent IA pourra ensuite répondre aux questions en se basant sur le contenu de ces documents.
...
1. Cliquez sur l'**icône Google Drive** dans la rangée d'icônes de stockage cloud
...
1. Utilisez le sélecteur de fichiers Google Drive pour parcourir vos fichiers
...
Les fichiers natifs Google Workspace sont automatiquement convertis lors de l'import :

| Type de fichier | Exporté sous forme de |
|-----------------|----------------------|
| Google Docs | Contenu textuel extrait |
| Google Sheets | Contenu textuel extrait |
| Google Slides | Contenu textuel extrait |
...
- **Aucun accès en écriture** à votre Google Drive
- **Aucun accès** aux fichiers que vous ne choisissez pas explicitement

<Callout type="info">
  Vous pouvez révoquer l'accès à tout moment depuis votre compte Google → Sécurité → Applications tierces.
</Callout>
...
2. **Sélection** — Choisissez des fichiers spécifiques via le sélecteur Google
...
- **Organisez d'abord** — Structurez vos dossiers Drive avant d'importer
...
- Vérifiez que les applications tierces sont autorisées dans vos paramètres Google
...
- Vos identifiants Google sont chiffrés
