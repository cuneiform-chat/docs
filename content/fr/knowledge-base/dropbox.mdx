...
Importez des documents depuis Dropbox pour entraîner vos agents IA.

## Aperçu

Connectez votre compte Dropbox à Cuneiform Chat et importez des documents directement dans votre contenu. Votre agent IA pourra ensuite répondre aux questions en se basant sur le contenu de ces documents.
...
### Étape 2 : Connecter Dropbox

1. Cliquez sur l'**icône Dropbox** dans la rangée d'icônes de stockage cloud
2. Connectez-vous avec votre compte Dropbox (si demandé)
3. Accordez à Cuneiform Chat la permission d'accéder à vos fichiers

### Étape 3 : Sélectionner les fichiers

1. Utilisez le sélecteur de fichiers Dropbox pour parcourir vos fichiers
...
- **Aucun accès en écriture** à votre compte Dropbox
- **Aucun accès** aux fichiers que vous ne choisissez pas explicitement

import { Callout } from 'nextra/components'

<Callout type="info">
  Vous pouvez révoquer l'accès à tout moment depuis Paramètres Dropbox → Applications connectées.
</Callout>
...
2. **Sélection** — Choisissez des fichiers spécifiques via le sélecteur Dropbox
...
- **Organisez d'abord** — Structurez vos dossiers Dropbox avant d'importer
...
- Vérifiez que vous êtes connecté au bon compte Dropbox
- Vérifiez que les applications tierces sont autorisées dans vos paramètres Dropbox
...
- Vos identifiants Dropbox sont chiffrés
