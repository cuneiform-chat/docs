...
Importez des documents depuis OneDrive pour entraîner vos agents IA.

## Aperçu

Connectez votre compte Microsoft à Cuneiform Chat et importez des documents directement dans votre contenu. Votre agent IA pourra ensuite répondre aux questions en se basant sur le contenu de ces documents.
...
1. Cliquez sur l'**icône OneDrive** dans la rangée d'icônes de stockage cloud
...
1. Utilisez le sélecteur de fichiers OneDrive pour parcourir vos fichiers
...
- **Aucun accès en écriture** à votre compte OneDrive
- **Aucun accès** aux fichiers que vous ne choisissez pas explicitement

import { Callout } from 'nextra/components'

<Callout type="info">
  Vous pouvez révoquer l'accès à tout moment depuis votre compte Microsoft → Confidentialité → Applications et services.
</Callout>
...
2. **Sélection** — Choisissez des fichiers spécifiques via le sélecteur OneDrive
...
- **Organisez d'abord** — Structurez vos dossiers OneDrive avant d'importer
...
### Impossible de se connecter à OneDrive

- Vérifiez que vous êtes connecté au bon compte Microsoft
- Vérifiez que les applications tierces sont autorisées dans vos paramètres Microsoft
...
- Vos identifiants Microsoft sont chiffrés
