...
<Callout type="info">
  Agent Flows fonctionne sur **WhatsApp, Telegram, Messenger et le widget de chat de votre site web**, et il est inclus pour tout le monde, essai gratuit compris. Concevez un flow une fois ; il s'affiche nativement sur chaque canal pris en charge.
</Callout>
...
Agent Flows lui-même est inclus pour tout le monde, essai gratuit compris : il n'y a rien à débloquer avant de créer votre premier flow. Ce que votre forfait détermine, c'est le nombre de flows qui peuvent être **publiés en même temps** et le nombre de langues dans lesquelles chaque flow publié paraît.
