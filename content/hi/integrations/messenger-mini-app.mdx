...
**अपने Facebook Page को एक पूरे in-app storefront में बदलें।** एक polished, multipage product catalog बनाएँ — photos, videos, themed pages, हर product के लिए एक AI assistant, और lightweight order-taking के साथ — जो *Messenger के अंदर* तभी खुल जाता है जब कोई customer आपके Page के Persistent Menu पर **"Open Storefront"** button टैप करता है। कोई app store नहीं, कोई अलग website नहीं, और ख़ुद बनाने के लिए कोई अलग checkout page भी नहीं: इसे किसी connected store से जोड़ दें — shoppers आपके असली checkout पर भुगतान करेंगे; इसे हाथ से बनाएँ — orders आपके inbox में अनुरोध के रूप में आएँगे। बस एक टैप, और आपका customer browse कर रहा है।
...
- **Customers कभी Messenger नहीं छोड़ते।** कोई app install नहीं, याद रखने के लिए कोई domain नहीं, ख़ुद बनाने के लिए कोई अलग checkout page नहीं। storefront Messenger के WebView में खुलता है और user की theme व language को inherit करता है।
...
- **हर plan पर मुफ़्त।** pages, blocks प्रति page या product docs पर कोई cap नहीं — किसी भी plan पर नहीं, free trial सहित। Pricing per-org है — दूसरा Facebook Page जोड़ने से आपकी price नहीं बदलती।
...
- **Products पाने के दो तरीक़े।** **हाथ से बनाया गया** storefront एक polished catalog + lead-capture surface है: products आप ख़ुद लिखते हैं, और वह न payments करता है, न inventory, न shipping। **Catalog से जुड़ा** storefront आपके [connected Shopify या WooCommerce store](/commerce) से products लेता है और shoppers को आपके असली checkout पर भेजता है।
...
Telegram Storefront जैसा ही scope। ये सीमाएँ उस storefront पर लागू होती हैं जिसमें products आपने ख़ुद लिखे हैं — [catalog से जुड़ा storefront](/integrations/telegram-mini-app#catalog-linked-storefronts) पहली तीन हटा देता है, क्योंकि वह products, stock और checkout आपके connected store से लेता है।

- **अपना कोई payment नहीं।** Order CTAs inquiry handoffs हैं, Checkout API या Stripe नहीं। (Catalog से जुड़ा storefront उसके बदले आपके store के checkout पर handoff करता है — देखें [Checkout](/commerce/checkout)।)
- **कोई inventory tracking नहीं।** product cards पर availability badges free-text labels हैं जिन्हें आप manually edit करते हैं ("Sold out", "Pre-order", "Last 3")। (Catalog से जुड़ा storefront आपके store से असली stock पढ़ता है।)
- **कोई shipping calculations / address validation नहीं।** Delivery address free-form text के रूप में collect होता है। (Catalog से जुड़े storefront में shipping आपके अपने store की ही shipping है, जो उसके checkout पर गिनी जाती है।)
