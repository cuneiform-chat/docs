...
- Thread context awareness के साथ conversation memory और text-based responses
...
**Thread context awareness (Spaces):** किसी Space thread में bot को @mention करने पर, bot जवाब देने से पहले पूरा thread history पढ़ता है — यह समझता है कि team पहले से क्या discuss कर रही थी। उसी thread में बाद की @mentions स्वचालित रूप से conversational continuity बनाए रखती हैं।
