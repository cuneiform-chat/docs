...
4. अब bot हर @mention से पहले के पिछले 24 घंटों में Space में भेजे गए सबसे हाल के messages (अधिकतम 10) पढ़ सकता है
...
**Space context awareness (opt-in):** किसी Space manager के `/connect` चलाने के बाद, bot हर @mention से पहले के पिछले 24 घंटों में Space में भेजे गए सबसे हाल के messages (अधिकतम 10) पढ़ता है — इसलिए वह समझता है कि team पहले से क्या discuss कर रही थी, बिना आपको context दोहराने की जरूरत के। Setup steps के लिए नीचे [Thread History Awareness](#thread-history-awareness) देखें।
