...
**अपने Telegram bot को एक पूरे in-app storefront में बदलें।** एक polished, multipage product catalog बनाएं — photos, videos, themed pages, हर product के लिए एक AI assistant, और lightweight order-taking के साथ — जो *Telegram के अंदर* तभी खुलता है जब कोई customer आपके bot के menu button को tap करता है। कोई app store नहीं, कोई अलग website नहीं, और ख़ुद बनाने के लिए कोई अलग checkout page भी नहीं: इसे किसी connected store से जोड़ दें — shoppers आपके असली checkout पर भुगतान करेंगे; इसे हाथ से बनाएँ — orders आपके inbox में अनुरोध के रूप में आएँगे। बस एक tap, और आपका customer browse कर रहा है।
...
- **Customers कभी Telegram नहीं छोड़ते।** कोई app install नहीं, याद रखने के लिए कोई domain नहीं, ख़ुद बनाने के लिए कोई अलग checkout page नहीं। storefront Telegram के WebView में खुलता है और user की theme, language, और login को inherit करता है।
...
- **हर plan पर free।** pages, blocks per page या product docs पर कोई cap नहीं — किसी भी plan पर नहीं, free trial सहित। Pricing per-org है — दूसरा Telegram bot जोड़ने से आपकी price नहीं बदलती।
...
- **Products पाने के दो तरीक़े।** **हाथ से बनाया गया** storefront एक polished catalog + lead-capture surface है: products आप ख़ुद लिखते हैं, और वह न payments करता है, न inventory, न shipping; इसे अपने inbox में एक इंसान के साथ pair करें और आपके पास एक पूरा sales loop है। **Catalog से जुड़ा** storefront आपके connected Shopify या WooCommerce store से products लेता है और shoppers को आपके असली checkout पर भेजता है। [नीचे देखें](#catalog-linked-storefronts)।
...
<Callout type="info">
  **storefront शुरू करने के दो तरीके।** सबसे तेज़ है **Storefront** hub (left nav → **Storefront** → **Create storefront**): यह एक नया storefront बनाता है जिसे आप पहले build करके बाद में किसी भी channel पर — एक Telegram bot, एक Facebook Page, या दोनों पर — इसके **Distribute** tab से publish कर सकते हैं। नीचे दिया per-bot entry (**Integrations → आपका bot → Configure mini app**) अब भी काम करता है और तब सुविधाजनक है जब आप पहले से bot card पर हों।
</Callout>
...
आपके द्वारा attach किए जा सकने वाले product docs की कुल संख्या पर कोई cap नहीं है ([Tier limits](#tier-limits) देखें)।

## Order inquiries & cart (optional) [#orders-and-cart]

आप किसी भी product card या product grid पर एक **Order CTA** attach कर सकते हैं। **हाथ से बनाए गए** storefront में यह विशुद्ध रूप से एक structured-message handoff है — **कोई payments नहीं, कोई inventory नहीं, कोई fulfillment नहीं** — और वह किसी इंसान के उठाने के लिए आपके inbox में आता है। **Catalog से जुड़े** storefront में वही CTA उसके बदले shopper को आपके store के असली checkout तक ले जा सकता है; देखें [Catalog से जुड़े storefronts](#catalog-linked-storefronts)।
...
## Catalog से जुड़े storefronts [#catalog-linked-storefronts]

ऊपर बताया गया सब कुछ उस storefront के लिए है जिसे आप हाथ से बनाते हैं: products, कीमतें और उपलब्धता आप ख़ुद लिखते हैं, और orders अनुरोध के रूप में आते हैं। किसी brochure, सेवाओं की सूची या menu के लिए यही अब भी सही रूप है।

अगर आपके पास एक **[connected Shopify या WooCommerce store](/commerce)** है, तो storefront को उसके बदले **उस catalog से जोड़ा** जा सकता है। इसके product blocks आपके असली catalog से आते हैं, कीमतें और stock आपके हाथ से लिखे किसी विवरण के बजाय store से आते हैं, और इसके order CTAs खरीदने को तैयार shopper को उसकी cart ज्यों की त्यों रखते हुए आपके अपने store के checkout तक ले जा सकते हैं — देखें [Checkout](/commerce/checkout)।

| | हाथ से बनाया गया | Catalog से जुड़ा |
|---|---|---|
| **Products** | आप लिखते हैं | connected store से आते हैं |
| **कीमत और उपलब्धता** | आपके रखे free-text खाने | आपके store से पढ़े जाते हैं |
| **Order CTA** | आपके Inbox में inquiry handoff | आपके store के checkout पर handoff |
| **connected store चाहिए** | नहीं | हाँ |

एक storefront एक ही स्रोत से बँधा होता है, और उस पर product blocks आ जाने के बाद वह बँधन तय हो जाता है — इसलिए हाथ से बना storefront चुपचाप catalog से जुड़े storefront जैसा बर्ताव करना शुरू नहीं कर सकता, और न ही उल्टा। catalog linking आने से पहले बने storefronts किसी स्रोत से बँधे नहीं हैं और ठीक पहले की तरह काम करते रहते हैं।
...
हर plan पर उपलब्ध, free trial सहित — और किसी भी plan पर pages, blocks per page या product docs की **कोई cap नहीं** है, free trial सहित।

Notes:

- एक product grid या carousel composer की block सूची में **1 block के रूप में गिना जाता है**, चाहे इसमें कितने भी items या slides हों।
- **Pricing per-org है, per-bot नहीं।** आपके org में दूसरा (या पाँचवाँ) Telegram bot जोड़ना आपकी price को **नहीं** बदलता। हर bot को उसी plan के अंदर अपना खुद का storefront मिलता है।
...
## हाथ से बनाया गया storefront क्या नहीं करता

ये सीमाएँ उस storefront पर लागू होती हैं जिसमें products आपने ख़ुद लिखे हैं। [Catalog से जुड़ा storefront](#catalog-linked-storefronts) पहली तीन हटा देता है, क्योंकि वह products — और checkout — आपके connected store से लेता है।

- **अपना कोई payment नहीं।** Order CTAs inquiry handoffs हैं, Stripe / WhatsApp Pay / Telegram Stars checkouts नहीं। (Catalog से जुड़ा storefront उसके बदले आपके store के checkout पर handoff करता है।)
- **No inventory tracking।** Availability badges free-text labels हैं जिन्हें आप manually edit करते हैं। (Catalog से जुड़ा storefront आपके store से असली stock पढ़ता है।)
- **No shipping calculations / address validation।** delivery address free-form text के रूप में collect होता है। (Catalog से जुड़े storefront में shipping आपके अपने store की ही shipping है, जो उसके checkout पर गिनी जाती है।)
