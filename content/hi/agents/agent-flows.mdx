...
<Callout type="info">
  Agent Flows **WhatsApp, Telegram, Messenger और आपकी वेबसाइट के chat widget** पर चलता है, और यह सबके लिए शामिल है — free trial सहित। एक flow एक बार बनाएँ; यह हर समर्थित channel पर native रूप से render होता है।
</Callout>
...
Agent Flows ख़ुद सबके लिए शामिल है, free trial सहित — पहला flow बनाने से पहले unlock करने जैसा कुछ नहीं है। आपकी सदस्यता जो तय करती है वह अलग है: एक साथ कितने flows **published** रह सकते हैं, और published हर flow कितनी भाषाओं में प्रकाशित होता है।
