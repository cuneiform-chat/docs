...
अपने AI agents को train करने के लिए OneDrive से documents import करें।

## Overview

अपने Microsoft account को Cuneiform Chat से connect करें और documents सीधे अपने content में import करें। आपका AI agent फिर इन documents के content के आधार पर प्रश्नों के उत्तर दे सकता है।
...
### Step 2: OneDrive से Connect करें

1. Cloud storage icons row में **OneDrive icon** पर click करें
2. अपने Microsoft account से sign in करें (यदि prompt हो)
3. Cuneiform Chat को अपनी files access करने की permission दें

### Step 3: Files Select करें

1. अपनी files browse करने के लिए OneDrive file picker उपयोग करें
...
- आपके OneDrive account का **No write access**
- जो files आप explicitly choose नहीं करते उनका **No access**

import { Callout } from 'nextra/components'

<Callout type="info">
  आप किसी भी समय अपने Microsoft Account → Privacy → Apps and services से access revoke कर सकते हैं।
</Callout>
...
2. **Selection** — OneDrive के picker के माध्यम से specific files चुनें
...
- **पहले organize करें** — Import करने से पहले अपने OneDrive folders structure करें
...
### OneDrive से Connect नहीं हो पा रहा

- Verify करें कि आप सही Microsoft account में sign in हैं
- Check करें कि third-party apps आपके Microsoft settings में allowed हैं
...
- आपके Microsoft credentials encrypted होते हैं
