...
| Crawling | Actively pages visit हो रहे हैं |
| Completed | सभी reachable pages crawl हो गए |
| Partial | कुछ pages crawl हुए, कुछ fail हुए |
...
उ: Maximum pages की संख्या आपके plan पर निर्भर करती है। Crawler आपके starting URL से 2 levels deep तक links follow करता है।
...
उ: Pages bot protection (Cloudflare जैसे firewalls), server errors, या empty content के कारण fail हो सकते हैं। Crawl "Partial" status दिखाएगा।
