...
अपने AI agents को train करने के लिए Dropbox से documents import करें।

## Overview

अपने Dropbox account को Cuneiform Chat से connect करें और documents सीधे अपने content में import करें। आपका AI agent फिर इन documents के content के आधार पर प्रश्नों के उत्तर दे सकता है।
...
### Step 2: Dropbox से Connect करें

1. Cloud storage icons row में **Dropbox icon** पर click करें
2. अपने Dropbox account से sign in करें (यदि prompt हो)
3. Cuneiform Chat को अपनी files access करने की permission दें

### Step 3: Files Select करें

1. अपनी files browse करने के लिए Dropbox file picker उपयोग करें
...
- आपके Dropbox account का **No write access**
- जो files आप explicitly choose नहीं करते उनका **No access**

import { Callout } from 'nextra/components'

<Callout type="info">
  आप किसी भी समय Dropbox Settings → Connected apps से access revoke कर सकते हैं।
</Callout>
...
2. **Selection** — Dropbox के picker के माध्यम से specific files चुनें
...
- **पहले organize करें** — Import करने से पहले अपने Dropbox folders structure करें
...
### Dropbox से Connect नहीं हो पा रहा

- Verify करें कि आप सही Dropbox account में sign in हैं
- Check करें कि third-party apps आपके Dropbox settings में allowed हैं
...
- आपके Dropbox credentials encrypted होते हैं
