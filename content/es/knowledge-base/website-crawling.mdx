...
R: El número máximo de páginas depende de su plan. El crawler sigue enlaces desde su URL inicial hasta el límite de profundidad configurado.
...
R: Las páginas pueden fallar por protección contra bots (firewalls como Cloudflare), errores del servidor o contenido vacío. El rastreo mostrará el estado "Partial Success".
