...
Importe documentos desde Box para entrenar a sus AI agents.

## Descripción General

Conecte su cuenta de Box a Cuneiform Chat e importe documentos directamente a su content. Su AI agent podrá entonces responder preguntas basándose en el contenido de estos documentos.
...
1. Haga clic en el **icono de Box** en la fila de iconos de cloud storage
2. Inicie sesión con su cuenta de Box (si se le solicita)
3. Otorgue permiso a Cuneiform Chat para acceder a sus archivos

### Paso 3: Seleccionar Archivos

1. Use el selector de archivos de Box para explorar sus archivos
...
- **Sin acceso de escritura** a su cuenta de Box
- **Sin acceso** a archivos que no elija explícitamente

import { Callout } from 'nextra/components'

<Callout type="info">
  Puede revocar el acceso en cualquier momento desde Configuración de Box → Seguridad → Aplicaciones conectadas.
</Callout>
...
2. **Selección** — Elige archivos específicos a través del selector de Box
...
- **Organice primero** — Estructure sus carpetas de Box antes de importar
...
### No se puede conectar a Box

- Verifique que esté conectado a la cuenta de Box correcta
- Compruebe que las aplicaciones de terceros estén permitidas en su configuración de Box
...
- Sus credenciales de Box están encriptadas
