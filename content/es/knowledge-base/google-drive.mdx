...
Importe documentos desde Google Drive para entrenar a sus AI agents.

## Descripción General

Conecte su cuenta de Google a Cuneiform Chat e importe documentos directamente a su content. Su AI agent podrá entonces responder preguntas basándose en el contenido de estos documentos.
...
1. Haga clic en el **icono de Google Drive** en la fila de iconos de cloud storage
2. Inicie sesión con su cuenta de Google (si se le solicita)
3. Otorgue permiso a Cuneiform Chat para acceder a sus archivos

### Paso 3: Seleccionar Archivos

1. Use el selector de archivos de Google Drive para explorar sus archivos
...
Los archivos nativos de Google Workspace se convierten automáticamente durante la importación:

| Tipo de Archivo | Se Exporta Como |
|-----------------|-----------------|
| Google Docs | Contenido de texto extraído |
| Google Sheets | Contenido de texto extraído |
| Google Slides | Contenido de texto extraído |
...
- **Sin acceso de escritura** a su Google Drive
- **Sin acceso** a archivos que no elija explícitamente

<Callout type="info">
  Puede revocar el acceso en cualquier momento desde su Cuenta de Google → Seguridad → Aplicaciones de terceros.
</Callout>
...
2. **Selección** — Elige archivos específicos a través del selector de Google
...
- **Organice primero** — Estructure sus carpetas de Drive antes de importar
...
- Verifique que esté conectado a la cuenta de Google correcta
- Compruebe que las aplicaciones de terceros estén permitidas en su configuración de Google
...
- Sus credenciales de Google están encriptadas
