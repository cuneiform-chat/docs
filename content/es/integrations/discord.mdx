...
- [Adjuntos de documentos](/integrations/document-attachments) — adjunta un archivo y pregunta sobre él (activado por defecto, planes de pago)
...
En Discord está **activado por defecto**: un administrador puede desactivar **Permitir archivos adjuntos** en la tarjeta de la integración. Consulta [Adjuntos de Documentos](/integrations/document-attachments) para los tipos admitidos, los límites y la configuración.
