...
<Callout type="info">
  Agent Flows funciona en **WhatsApp, Telegram, Messenger y el widget de chat de tu sitio web**, y está incluido para todo el mundo, prueba gratuita incluida. Crea un flow una vez; se renderiza de forma nativa en cada canal compatible.
</Callout>
...
Agent Flows en sí está incluido para todo el mundo, prueba gratuita incluida: no hay nada que desbloquear antes de crear tu primer flow. Lo que sí depende de tu suscripción es cuántos flows pueden estar **publicados a la vez** y en cuántos idiomas se publica cada uno.
