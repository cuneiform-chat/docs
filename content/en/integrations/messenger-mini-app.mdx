...
The composer is the **same editor** as the Telegram Storefront — see [Telegram Storefront: The composer](/integrations/telegram-mini-app#the-composer) for the full tour (3-pane layout, draft/publish lifecycle, image cropper, tier limits). The only channel-specific surface is the **Distribute** tab.
