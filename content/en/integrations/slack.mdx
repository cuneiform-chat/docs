...
- [Document attachments](/integrations/document-attachments) — upload a file and ask about it (off by default, paid plans)
...
This is **off by default** on Slack: an admin switches on **Allow document attachments** on the integration card. See [Document Attachments](/integrations/document-attachments) for supported types, limits and setup.
