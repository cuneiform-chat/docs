...
<Callout type="info">
  Agent Flows runs on **WhatsApp, Telegram, Messenger, and your website chat widget**, and it's included for everyone — free trial included. Build a flow once; it renders natively on every supported channel.
</Callout>
...
Agent Flows itself is included for everyone, free trial included — there's nothing to unlock before you build your first flow. What your plan governs is how many flows can be **live at once**, and how many languages each live flow is published in.
