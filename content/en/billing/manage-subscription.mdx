...
If your subscription enters a payment-failed state, an **Update Payment Method** button appears on the **Your Plan** card. Clicking it opens the Polar customer portal in a new tab where you can:
...
Cancellations are handled through the Polar customer portal. Contact support, or — if your subscription has entered a payment-failed state — use the **Update Payment Method** button on the **Your Plan** card to open the portal and cancel from there. Access continues until the end of your current billing period.
