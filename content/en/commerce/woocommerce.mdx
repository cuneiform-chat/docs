...
<Callout type="warning">
  If you still have a **Shopify** store connected, only the workspace-wide steps — archiving commerce Agent Flows and deleting quiz suggestions — are skipped. The WooCommerce store's own catalog, product knowledge, Storefronts, analytics and store agent are always torn down.
</Callout>
