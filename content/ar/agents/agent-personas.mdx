...
<Callout type="info">
  Variables are resolved at message-send time using your organization's actual values. There is no in-UI preview — test in the [Playground](/agents/testing) to verify the rendered prompt.
</Callout>
