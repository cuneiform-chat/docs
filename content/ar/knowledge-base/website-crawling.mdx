...
A: The maximum number of pages depends on your plan. The crawler follows links from your starting URL up to a fixed depth — or, if you enable **Single page only**, it stops at the entered URL and skips link-following entirely.
...
A: Pages can fail due to bot protection (firewalls like Cloudflare), server errors, or empty content. The crawl will show "Partial Success" status.
