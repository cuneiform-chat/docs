---
description: Monitor agent performance, track conversations, and analyze usage across all channels.
---
...
<Cards>
  <Cards.Card title="Conversations" href="/analytics/conversations" />
  <Cards.Card title="Usage Metrics" href="/analytics/usage" />
...
The main dashboard supports **Date range** selection and **Granularity** controls. To filter by Agent or Channel, open the [Conversations page](/analytics/conversations), which exposes Agent and Channel dropdowns alongside its date range.
