...
يُنشر العقد الكامل أيضًا كمواصفات **OpenAPI 3.1** مكتوبة يدويًا، [`openapi.yaml`](https://docs.cuneiform.chat/openapi.yaml)، قابلة للتنزيل بجانب هذا المرجع. وهي المصدر الوحيد للحقيقة الذي كُتبت بناءً عليه الصفحات هنا — كل حقل في المخطط هو حقل تُرجعه الواجهة فعليًا، ولا يظهر أي حقل داخلي.
