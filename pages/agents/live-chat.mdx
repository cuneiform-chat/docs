...
User asks to speak with a human
  ...
  → Session appears in the Live Chat queue (status: Queued)
  → Team members receive in-app notification
  → If no response in 3 min, email reminder sent
  → Team member opens Live Chat and clicks Accept
...
## Using the Live Chat Page

Navigate to **Live Chat** in the sidebar to see the handoff queue.
...
- **Agents online** — How many team members have the Live Chat page open

<Callout type="info">
  Your online status is tracked automatically while you have the Live Chat page open. No manual "go online" action is needed.
</Callout>
...
Yes. Any team member in your organization can accept queued sessions. The "Agents online" counter shows how many team members currently have the Live Chat page open.

### What if I close my browser during an active chat?

The session remains Active. When you return to the Live Chat page, you can continue the conversation where you left off.
...
Yes. Use the status filter on the Live Chat page to view **Resolved** or **Expired** sessions. Click any session to review the full conversation.
