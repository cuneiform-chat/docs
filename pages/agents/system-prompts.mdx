...
Personalize your agent's greeting and fallback messages with dynamic variables.
...
| `{{company_industry}}` | Your industry type | "technology" |
| `{{support_email}}` | Support email address | "help@acme.com" |
| `{{website_url}}` | Company website | "https://acme.com" |
| `{{current_date}}` | Today's date | "2026-02-03" |
| `{{current_year}}` | Current year | "2026" |

### Using Variables

In your greeting or fallback message:

```
Welcome to {{organization_name}}! I'm here to help you with any questions about our {{company_industry}} solutions.
```

**Result:** "Welcome to Acme Corp! I'm here to help you with any questions about our technology solutions."

### Where to Use

- **Greeting Message** — First message users see
- **Fallback Response** — When agent can't answer
