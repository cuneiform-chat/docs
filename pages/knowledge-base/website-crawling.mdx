...
Crawl public websites and add the content to your Knowledge Base. The crawler visits pages, extracts content as Markdown, and lets you review and edit before processing.

## Getting There

Navigate to **Knowledge** in the sidebar, then click the **Website** tab.
...
After crawling completes, you can review and edit pages before adding them to your Knowledge Base.
...
A: In the **Documents** tab of the Knowledge page. They appear as Markdown (.md) files.
