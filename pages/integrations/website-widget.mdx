...
Visitor opens your website
  ...
  → AI agent searches your knowledge base
  → Response streams in real-time
```

Messages are processed in real-time. The agent searches your knowledge base and generates responses using the same AI pipeline as all other channels.
...
2. Verify the agent has documents in its knowledge base
